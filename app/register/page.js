...
export default function Home() {
    ...
    const handleRegister = async (e) => {
      ...
      await setDoc(doc(db, 'users', user.email), { name, email, uid: user.uid });
        router.push('/');
      } catch (error) {
    ...
    <main>
      ...
      <motion.div 
          ...
          <div className="flex flex-col text-start md:text-left md:flex-row h-screen justify-evenly md:items-center">
            <div className="w-full md:w-4/5 lg:w-[560px] mx-auto md:mx-0 hidden sm:block">
              <div className="bg-white p-10 flex flex-col w-full shadow-xl rounded-xl">
                <h2 className="text-2xl font-bold text-gray-800 text-left mb-5 tracking-wide">
                  Sigup
                </h2>
                <form onSubmit={handleRegister} className="w-full">
                  <div className="flex flex-col w-full my-5">
                    <label htmlFor="fullname" className="text-gray-500 mb-2">
                      Full Name
                    </label>
                    <input
                      id="name"
                  ...
                  <div className="flex flex-col w-full my-5">
                    ...
                    >
                      <div className="flex flex-row items-center justify-center">
                        ...
                        <div className="font-bold text-base sm:text-xl tracking-wide">Sigup</div>
                      </div>
                    </button>}
                    {loadingBtn && <button
                      type="button"
                  ...
                  <div className="flex justify-start mt-6">
                    <Link href="/signin" className="text-center font-semibold text-green-500 pl-3">
        ...
        <div  className="w-full h-full flex justify-center items-center sm:hidden z-50 overflow-y-auto">
          <div className="bg-white p-3 flex flex-col w-full registerDiv">
            <h2 className="text-2xl font-bold text-gray-800 text-left mb-2">
              Welcome to ChatAlpa!
            </h2>
            <p className="text-lg font-medium text-gray-600 text-left mb-3">To get started, create your account.</p>
            <form onSubmit={handleRegister} className="w-full">
              <div className="flex flex-col w-full my-5">
                <label htmlFor="fullname" className="text-gray-500 mb-2">
                  Full Name
